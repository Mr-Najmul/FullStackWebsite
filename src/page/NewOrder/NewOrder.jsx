...
const NewOrder = () => {
  ...
  useEffect(() => {
    const uri = `https://intense-falls-76179.herokuapp.com/package/${id}`;
    axios
      .get(uri)
  ...
  useEffect(() => {
    if (paymentStatus?.status === true) {
      const uri = `https://intense-falls-76179.herokuapp.com/order/`;
      axios
        .post(uri, formData)
        .then(function (response) {
    ...
    <div className="">
      <div className="d-flex row g-0">
        ...
        <div className="col-md-9">
          <DashboardTopNav pageTitle="Booking Service / Package" />
